...
config :dashboard, DashboardWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "L3IEstAD2Tq6nXPc2cUpGta99RmT3AvEs18JYCHPzzw3nmgoXgg7uwO1Na/f9AGn",
  render_errors: [view: DashboardWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: Dashboard.PubSub,
  live_view: [signing_salt: "pXQG6L7r"]
...
config :kafka_ex,
  ...
  brokers: [
    {System.get_env("KAFKA_HOST", "localhost"), System.get_env("KAFKA_PORT", "32000") |> String.to_integer}
  ],
  #
  # OR:
